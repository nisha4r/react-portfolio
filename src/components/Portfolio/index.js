                ...
                <Stack as={Box} textAlign={'center'} spacing={{ base: 8, md: 14 }} pb={{ base: 18, md: 34 }}>
                    ...
                    <Stack spacing={4} px={4}>
                       {/* <Fade initialScale={0.5} in={inViewport > 0}  whileHover={{scale:0.8}} > */}
                            <Card overflow={'hidden'} direction={{base: "column"}} shadow={'md'} m={3} p={3} >
                                <Image objectFit={'cover'} src={foodImage} alt='HTML CSS'></Image>
                                <Stack>
                                    <CardBody align="left">
                    ...
                    <Stack spacing={4} px={4}>
                       {/* <Fade initialScale={0.5} in={inViewport > 0}  whileHover={{scale:0.8}} > */}
                            <Card overflow={'hidden'} direction={{base: "column"}} shadow={'md'} m={3} p={3}>
                                <Image objectFit={'cover'} src={byeByeFresh} alt='HTML CSS'></Image>
                                <Stack>
                                    <CardBody align="left">
